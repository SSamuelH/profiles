    ...
    if (/^https:\/\/www\.gamemale\.com\/wodexunzhang-showxunzhang\.html/.test(currentUrl) || /^https:\/\/www\.gamemale\.com\/plugin\.php\?id=wodexunzhang%3Ashowxunzhang&fid=/.test(currentUrl)) {
        ...
        if (isCurrentUrlMatched) {
            async function run() {
                ...
                let maid = ["红夫人", "贝儿(Belle)", "莫瑞甘", "贝优妮塔", "莎伦", "绯红女巫", "赫敏·格兰杰", "梅格", "山村贞子", "蒂法·洛克哈特", "九尾妖狐·阿狸", "丹妮莉丝·坦格利安", "希尔瓦娜斯·风行者", "刀锋女王", "维涅斯", "星籁歌姬", "莫甘娜", "凯尔", "露娜弗蕾亚·诺克斯·芙尔雷", "凯特尼斯·伊夫狄恩", "爱丽丝·盖恩斯巴勒", "朱迪·霍普斯", "“米凯拉的锋刃”玛莲妮"];
