...
jQuery(function ($) {
    ...
    */
    ...
    class Task {
        ...
        ${i18n(this.title)}
        <button class="my_pixiv_button start">${i18n("ui_start")}</button>
        <button class="my_pixiv_button pause">${i18n("ui_pause")}</button>
        <button class="my_pixiv_button resume">${i18n("ui_resume")}</button>
        <button class="my_pixiv_button retry">${i18n("ui_retry")}</button>
        <button class="my_pixiv_button cancel">${i18n("ui_cancel")}</button>
        <span class="status">
